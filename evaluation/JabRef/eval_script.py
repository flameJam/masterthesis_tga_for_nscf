...
no_real_read_report_json_path = "assessments/no_real_read_2022-10-28.json"
real_read_report_json_path = "assessments/real_read_2022-10-28.json"


test_resources_regex_list = [re.compile("^src/test/resources/.+")]

figure_location="<hardcoded figure path>"
